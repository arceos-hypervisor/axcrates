...
> **说明**：`[组织名]` 标注表示该组件所属的 GitHub 组织。部分仓库（如 `arceos`、`axplat_crates` 等）包含多个 crate，在表格中以"与 `xxx` 同仓库"标注。
...
| axplat-riscv64-visionfive2 | [![Crates.io](https://img.shields.io/crates/v/axplat-riscv64-visionfive2)](https://crates.io/crates/axplat-riscv64-visionfive2) | https://github.com/arceos-org/axplat_crates | 与 `axplat_crates` 同仓库 | VisionFive2 RISC-V 平台 |
...
| starry-process | [![Crates.io](https://img.shields.io/crates/v/starry-process)](https://crates.io/crates/starry-process) | https://github.com/Starry-OS/starry-process | `components/starry-process` | 进程管理 |
| starry-signal | [![Crates.io](https://img.shields.io/crates/v/starry-signal)](https://crates.io/crates/starry-signal) | https://github.com/Starry-OS/starry-signal | `components/starry-signal` | 信号处理 |
| starry-vm | [![Crates.io](https://img.shields.io/crates/v/starry-vm)](https://crates.io/crates/starry-vm) | https://github.com/Starry-OS/starry-vm | `components/starry-vm` | 虚拟内存管理 |
| starry-smoltcp | [![Crates.io](https://img.shields.io/crates/v/starry-smoltcp)](https://crates.io/crates/starry-smoltcp) | https://github.com/Starry-OS/smoltcp | `components/starry-smoltcp` | 网络协议栈 |
